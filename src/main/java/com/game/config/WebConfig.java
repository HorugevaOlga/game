...
import com.game.controller.StringToProfessionConverter;
import com.game.controller.StringToRaceConverter;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addConverter(new StringToProfessionConverter());
